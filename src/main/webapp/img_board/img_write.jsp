...
<head>
<meta charset="UTF-8">
<title>img_board/img_write.jsp</title>
<style type="text/css">
table {
	border: solid 3px;
	text-align: center;
...
<body>
	...
	<div id="wrap">
		...
		<article style="display: table; width: 1300px; margin: 50px auto;">
			<h1>Gallery Write</h1>
			<form action="img_writePro.jsp" method="post" enctype="multipart/form-data">
				<table class="table">
					<tr>
      					<th>글쓴이</th>
    				...
    				<tr>
      					<th>파일</th>
    					<td><input class="form-control" type="file" name="original_file" id="formFile" required="required"></td>
    				</tr>
				</table>

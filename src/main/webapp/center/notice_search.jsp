	...
	<article style="display: table; margin: 50px auto;">
		<table class="table" style="width: 1300px; float:left;">
		    ...
		    <%for(BoardDTO board : boardList) {
		    	...
		    	int replyCount = replyDAO.replyCount(board.getNum(), "notice");
		    %>
		    	 <tr class="table-light" style="cursor:pointer;" onclick="location.href='notice_content.jsp?num=<%=board.getNum()%>'">
		...
		<div id="table_search">
				<button type="button" style="float: left;" class="btn btn-light" onclick="func1()">글쓰기</button>
			<form style="display: inline;" action="notice_search.jsp" method="get">
		...
		<div style="width: 300px; margin-left: 50%; margin-right: auto;">
			...
			<%} else { %>
				<a style="text-decoration: none; font-size: 150%;" href="notice_search.jsp?keyword=<%=keyword %>&pageNum=<%=pageNum - 1%>">&laquo;</a>
			<%} %>
			...
			<%for(int i = startPage; i <= endPage; i++) { %>
				...
				<%} else { %>
					<a style="text-decoration: none; font-size: 150%;" href="notice_search.jsp?keyword=<%=keyword %>&pageNum=<%=i %>"><%=i %></a>
				<%} %>
			<%} %>
			...
			<%} else { %>
				<a style="text-decoration: none; font-size: 150%;" href="notice_search.jsp?keyword=<%=keyword %>&pageNum=<%=pageNum + 1%>">&raquo;</a>
			<%} %>

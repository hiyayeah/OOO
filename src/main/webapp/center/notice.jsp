...
<body>
	...
	<article style="display: table; margin: 50px auto;">
		...
		<div style="width: 300px; margin-left: 50%; margin-right: auto;">
			...
			<%} else { %>
				<a style="text-decoration: none; font-size: 150%;" href="notice.jsp?pageNum=<%=pageNum - 1%>">&laquo;</a>
			<%} %>
			...
			<%for(int i = startPage; i <= endPage; i++) { %>
				...
				<%} else { %>
					<a style="text-decoration: none; font-size: 150%;" href="notice.jsp?pageNum=<%=i %>"><%=i %></a>
				<%} %>
			<%} %>
			...
			<%} else { %>
				<a style="text-decoration: none; font-size: 150%;" href="notice.jsp?pageNum=<%=pageNum + 1%>">&raquo;</a>
			<%} %>
